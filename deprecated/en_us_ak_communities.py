...
dcced_communities= gpd.read_file('data/raw/dcced/data/dcced_communities.geojson')
...
communities.explore()
communities.to_file('data/derived/communities/communities.geojson')


# left join to usgs gnis data by nearest neighbor
usgs_places = gpd.read_file('data/raw/usgs/data/usgs_places.geojson')
...
derived_sales_report = gpd.read_file('data/raw/es/data/es_lookup_sales_report.geojson')
