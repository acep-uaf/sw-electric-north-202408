...
geo_save(
    ...
    geo_output = 'data/raw/cares/data/cares_boundary.geojson')
...
geo_save(
    ...
    geo_output = 'data/raw/cares/data/cares_regional_grids.geojson')
...
geo_save(
    ...
    geo_output = 'data/raw/cares/data/cares_regional_grids_capacity.geojson')

geo_save(
    geo_input = 'data/source/Shapefile_export/AEA-Transmission_Lines-202200706/Alaska_Energy_Authority_Library.shp',
    geo_output = 'data/raw/cares/data/cares_transmission.geojson'
)
