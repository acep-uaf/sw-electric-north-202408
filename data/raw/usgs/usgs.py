...
geo_save(
    ...
    geo_output = 'data/raw/usgs/data/usgs_incorporated.geojson'
)
...
geo_save(
    ...
    geo_output = 'data/raw/usgs/data/usgs_unincorporated.geojson'
)
...
geo_save(
    ...
    geo_output = 'data/raw/usgs/data/usgs_places.geojson'
)
